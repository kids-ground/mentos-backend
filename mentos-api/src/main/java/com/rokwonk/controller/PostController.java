...
import com.rokwonk.service.PostService;
...
public class PostController {
    ...
    public ResponseEntity<PostWriteResponse> createPost(
        ...
        PostWriteResponse postWriteResponse = postService.createPost(requestUser.memberId(), request);
...
//        ));
    ...
    public ResponseEntity<PostListResponse> getPostList(
        ...
        PostListResponse postList = postService.getPostList(request);
...
//        ));
    ...
    public ResponseEntity<CommentWriteResponse> createComment(
        ...
        CommentWriteResponse commentWriteResponse = postService.createComment(requestUser.memberId(), postId, request);
        return ResponseEntity.ok(commentWriteResponse);
    }
    ...
    public ResponseEntity<CommentListResponse> getCommentList(
        ...
        CommentListResponse commentList = postService.getCommentList(postId);
